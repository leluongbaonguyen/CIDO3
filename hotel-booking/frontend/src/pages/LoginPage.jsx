...
// DỮ LIỆU CỨNG TÀI KHOẢN (Đã đồng bộ với Seed V2)
const HARDCODED_USERS = {
  'admin': { email: 'admin@xtravel.com', password: '123456', label: 'Admin' },
  'staff': { email: 'staff@xtravel.com', password: '123456', label: 'Staff' },
  'customer': { email: 'khachhang1@gmail.com', password: '123456', label: 'Customer' }
};
      ...
      <div className="glass-effect" style={{ 
        ...
        <div style={{ textAlign: 'center', marginTop: '30px' }}>
           <Link to="/register" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none', fontSize: '14px' }}>
             Chưa có tài khoản? <span style={{ color: '#c4a661', fontWeight: '700' }}>Đăng ký ngay</span>
           </Link>
        </div>
      </div>
    </div>
